                            ...
                            <form class="advanced-search-property">
                                <div class="advanced-search-property-wrap">
                                    <div class="row">
                                        ...
                                        <div class="item-wrap col-md-3">
                                            <input type="text" id="case_number" name="built_at" value="" placeholder="جستجوی سال ساخت ... ">
                                        </div>
                                        <div class="item-wrap col-md-3">
                                            <input type="text" id="case_number" name="address" value="" placeholder="جستجوی آدرس ... ">
                                        </div>
                                        ...
                                        <div class="item-wrap col-md-3">
                                            <div class="price_slider_wrapper widget_price_filter price">
                                                ...
                                                <div class="price_slider_amount" data-currency="تومان" data-step="100000">
                                                    <input type="hidden" id="min_price" name="min_price" value="" data-min="0" placeholder="حداقل قیمت">
                                                    <input type="hidden" id="max_price" name="max_price" value="" data-max="100000000000" placeholder="حداکثر قیمت">
                                        ...
                                        <div class="item-wrap col-md-3">
                                            <select class="selection contract" name="contract" hidden >
                                                <option value="sale" selected>برای فروش</option>
                                            </select>
                                        </div>
                                    </div>
